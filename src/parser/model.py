...
def add_model_options(parser):
    ...
    group.add_argument("--lambda_vel", default=1.0, type=float, help="weight of the velocity divergence loss")
    group.add_argument("--lambda_velxyz", default=1.0, type=float, help="weight of the velocity divergence loss")
    ...
    # Initializations
    group.add_argument("--init_generation", type=str, required=False, help='Path to the initialized generative model checkpoint file.')
    group.add_argument("--init_recognition", type=str, required=False, help='Path to the initialized recognition model checkpoint file.')
