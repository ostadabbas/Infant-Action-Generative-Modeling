...
class InfActSyns(Dataset):
    dataname = "infactsyn"

    def __init__(self, datapath="./data/Syn", **kargs):
        self.datapath = datapath

        super().__init__(**kargs)

        datafilepath = os.path.join('./exps/infactposture_rc_rcxyz_velxyz_init200_epoch200', "generated_samples.npy") #os.path.join(datapath, "posture_generated_samples.npy")
